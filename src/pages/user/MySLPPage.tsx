              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold tracking-tight">{slp.full_name}</h2>
                ...
                <div className="flex items-center gap-2 self-start sm:self-center">
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold bg-white text-indigo-900 hover:bg-indigo-50 shadow-sm transition-all"
                  ...
                  <Button
                    ...
                    className="text-white/80 hover:text-red-300 hover:bg-white/10 text-xs border border-white/20 transition-all"
                  >
